...
<li class="nav-item">
  <a class="nav-link text-white " href="index.php?action=wiki">
    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
      ...
      <ul class="navbar-nav  justify-content-end">
        ...
        <li class="nav-item d-flex align-items-center">
            ...
            <a href="index.php?action=login"><span class="d-sm-inline d-none" >Sign In</span></a>
...
<div class="row">
  ...
  <h2 class="font-weight-bolder mb-0">All Wikis</h2>
</div>
...
<div class="row mt-4" style="margin-top: 20%;">
  ...
  <?php foreach ($wikis as $wiki): ?>
    ...
    <h6 class="ms-2 mt-4 mb-0"> <?php echo $wiki->getTitle(); ?> </h6>
    <p class="text-sm ms-2"> <?php $content = $wiki->getContent();  echo substr($content, 0, 50);?> </p>
